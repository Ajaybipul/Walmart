...
const WomensPage = () => {
  ...
  const { womens, status, error } = useSelector((state) => state.products);
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="pt-2">
        <div className="container mx-auto">
          <h1 className="text-2xl  text-gray-800 mb-2">Women's Clothing</h1>
          <img src="images/w2.png" alt="Saving" className="w-full h-auto mb-8" />
          <img src="images/w1.png" alt="Saving" className="w-full h-auto mb-8" />
          {/* Filter Section */}
          <div className="mb-8">
            <div className="flex ">
